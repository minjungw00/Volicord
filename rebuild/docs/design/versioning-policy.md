...
Materiality Review와 Learning Deliberation payload를 함께 해석하는 version `9` 하나다. Current-task
...
Current positive store만 reopen하며 version `8`과 다른 non-current value는
