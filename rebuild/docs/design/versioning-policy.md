...
Materiality Review와 Learning Deliberation payload를 함께 해석하는 version `11` 하나다. Current-task
...
Current positive store만 reopen하며 version `10`과 다른 non-current value는
