...
production/test candidate HEAD `4b1c87e31caec9ef88865467610c9ddc8a20c14e`.
...
| --- | --- | --- |
| Volicord reconstruction repository | `validated_candidate_head = 4b1c87e31caec9ef88865467610c9ddc8a20c14e` | authenticated Codex target `volicord`: status `passed`, classification `passed` |
...
unchanged at `4b1c87e31caec9ef88865467610c9ddc8a20c14e`.
...
| `final_command.cargo_metadata.outcome`; `final_command.cargo_metadata.exit_code`; `final_command.cargo_metadata.termination`; `final_command.cargo_metadata.spawn_error`; `final_command.cargo_metadata.duration_ms` | `succeeded`; `0`; `null`; `false`; `9.847` |
| `final_command.cargo_fmt` | `cargo fmt --manifest-path rebuild/Cargo.toml --all -- --check` |
| `final_command.cargo_fmt.outcome`; `final_command.cargo_fmt.exit_code`; `final_command.cargo_fmt.termination`; `final_command.cargo_fmt.spawn_error`; `final_command.cargo_fmt.duration_ms` | `succeeded`; `0`; `null`; `false`; `418.886` |
| `final_command.cargo_clippy` | `cargo clippy --manifest-path rebuild/Cargo.toml --workspace --all-targets --all-features` |
| `final_command.cargo_clippy.outcome`; `final_command.cargo_clippy.exit_code`; `final_command.cargo_clippy.termination`; `final_command.cargo_clippy.spawn_error`; `final_command.cargo_clippy.duration_ms` | `succeeded`; `0`; `null`; `false`; `5024.671` |
| `final_command.cargo_test` | `cargo test --manifest-path rebuild/Cargo.toml --workspace --all-targets --all-features` |
| `final_command.cargo_test.outcome`; `final_command.cargo_test.exit_code`; `final_command.cargo_test.termination`; `final_command.cargo_test.spawn_error`; `final_command.cargo_test.duration_ms` | `succeeded`; `0`; `null`; `false`; `25615.759` |
...
`final_summary_sha256 = c80c05bbd0fbed8e0c787ef00e5d8fb4f690e7c6c0bfea86ad70a8875d637a9c`.
...
`official_v11.result_sha256 = 1c40bcb8cead793b730e87bcb6569e5dae9ba0852e395f568feed4e95b35f1b4`.
...
The capsule records exact-final command durations of 9.847 ms, 418.886 ms,
5024.671 ms, and 25615.759 ms. It does not project official V11 per-step
...
`evidence_archive.candidate_head = 4b1c87e31caec9ef88865467610c9ddc8a20c14e`,
`evidence_archive.filename = validation-evidence-4b1c87e31cae.tar.gz`,
`evidence_archive.sha256 = 63a5de01a26cb4566d28f0491357e26d2fc2477085e35cf6d96870f306db8d75`,
`evidence_archive.size_bytes = 12343`, and
...
- Official V11 result SHA-256:
  `1c40bcb8cead793b730e87bcb6569e5dae9ba0852e395f568feed4e95b35f1b4`.
