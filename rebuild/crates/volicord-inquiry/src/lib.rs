...
pub use model::{
    ...
    CandidateRetention, CollectionOptOut, CollectionOptOutScope, CoupledArtifactAssessment,
    CoupledArtifactCategory, CoupledArtifactDisposition, CoupledArtifactReview,
    DiscoveredAlternativeAccounting, DiscoveredAlternativeResolution, DuplicateAssessment,
