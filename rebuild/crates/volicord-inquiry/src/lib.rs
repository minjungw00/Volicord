...
pub use model::{
    ...
    CollectionOptOutScope, DiscoveredAlternativeAccounting, DiscoveredAlternativeResolution,
    DuplicateAssessment, EngineeringAlternative, EngineeringChoice, EngineeringChoiceDiscovery,
    ...
    ExploratoryDisposition, InquiryScope, LateWorkAuthorityRevision, LearningAlternativeSelection,
    ...
    MaterialOutcomeOwnershipAssessment, MaterialOutcomeSignal, MaterialityAssessment,
