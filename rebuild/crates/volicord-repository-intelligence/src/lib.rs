...
pub use model::{
    ...
    CanonicalSourceRef, Capability, CapabilityReport, CapabilityState, CodeEntity, CodeEntityKind,
    ...
    FreshnessBasis, FreshnessState, GitObservation, GroundedExplanationBasis, GroundingEvidence,
    GroundingGap, GroundingStatementClass, InvalidationCategory, InvalidationRecord,
    ...
    SemanticProvenance, SemanticRefresh, SemanticRelation, SemanticRelationKind, SourcePosition,
    SourceRange, StructuralFact, StructuralProvenance, StructuralRefresh, StructuralRelation,
