...
| Which public errors or close-readiness blocker routes are valid? | [API error codes](../reference/api/error-codes.md), [API error routing](../reference/api/error-routing.md), plus the affected method and state-schema owners |
