...
<!-- BEGIN GENERATED: contract-structures api.method.request_user_action.response[response_variants] api.method.request_user_action.response[result_body] api.method.request_user_action.response[rejection] api.method.request_user_action.response[dry_run] -->
<!-- Generated by `cargo run -p xtask -- docs-sync`; do not edit this region. -->
...
<!-- END GENERATED: contract-structures api.method.request_user_action.response[response_variants] api.method.request_user_action.response[result_body] api.method.request_user_action.response[rejection] api.method.request_user_action.response[dry_run] -->
