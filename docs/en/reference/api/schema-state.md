...
<!-- BEGIN GENERATED: BaselineRef canonical scalar -->
<!-- Generated by `cargo run -p xtask -- docs-sync`; do not edit this region. -->
- A non-null `BaselineRef` is encoded as a UTF-8 string, but its accepted value set is exactly this byte-level canonical scalar contract.
  - byte length: `1..=64`
  - complete allowed ASCII byte alphabet: `-0123456789_abcdefghijklmnopqrstuvwxyz`
  - JSON Schema pattern: `^[\-0123456789_abcdefghijklmnopqrstuvwxyz]{1,64}$`
  - forbidden complete values: `null`
  - canonical examples: `baseline_example_001`, `baseline-example-001`, `0123456789abcdef0123456789abcdef01234567`, `aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa`
- Only a position explicitly typed as `BaselineRef | null` accepts actual JSON `null`. The string `null` is not a null sentinel and is invalid.
...
<!-- END GENERATED: BaselineRef canonical scalar -->
