...
- `dry_run=true` is rejected; this method has no preview response branch.
...
<!-- BEGIN GENERATED: contract-structures api.method.get_operation_result.response[response_variants] api.method.get_operation_result.response[result_body] api.method.get_operation_result.response[result_metadata] api.method.get_operation_result.response[rejection] -->
<!-- This region is generated from maintained sources; do not edit it directly. -->
...
| Field | Required | Nullable | Type |
|---|---|---|---|
| `base` | yes | no | `GetOperationResultResultBase` |
...
<!-- END GENERATED: contract-structures api.method.get_operation_result.response[response_variants] api.method.get_operation_result.response[result_body] api.method.get_operation_result.response[result_metadata] api.method.get_operation_result.response[rejection] -->
