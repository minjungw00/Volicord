...
| Record profile | 기록 프로필 | The first-release Agent Connection profile for cooperative Volicord workflow recording through managed stdio MCP. | [Administrative CLI](admin-cli.md) |
