...
- `volicord.prepare_write` and write tickets are bounded product-write or exact approval-bound sensitive-action authority mechanisms inside Volicord, not isolation or sandboxing guarantees.
