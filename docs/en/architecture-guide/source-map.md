...
| `crates/volicord-mcp/src/action_form.rs` | Generic descriptor-bound projection from neutral Agent `TransitionDescriptor` values to deterministic method-and-variant MCP form catalogs and variant-aware authority-only retry contracts. |
