...
| `crates/volicord-mcp/src/action_form.rs` | Generic descriptor-bound projection from the neutral Core workflow action catalog to deterministic method-and-variant MCP form catalogs and variant-aware authority-only retry contracts. |
