...
| `crates/volicord-types/src/integration_revision.rs` | Typed Connection/project integration revision bases and derivation, including distinct storage-manifest, managed-guidance, workflow-action-contract, and MCP-semantic-schema digest inputs. |
