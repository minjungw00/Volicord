...
| `tests/release-validation` | Test-only exact-final-artifact host release gate and separate-process audit package. It owns no production runtime behavior. |
