...
| `MVP1-focused-judgment-request` | 사용자 소유 판단이 필요하면 Core가 `judgment_kind`, `presentation`, options/consequences, related refs와 locale에서 파생한 표시 라벨을 가진 focused user judgment request를 기록하거나 반환합니다. 긴 questionnaire를 쏟아내거나 사용자를 대신해 고르지 않습니다. |
