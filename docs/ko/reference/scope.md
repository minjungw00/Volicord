...
| 쓰기 티켓 | `volicord.prepare_write`는 호환되는 제품 파일 쓰기 의도 하나를 위해 담당 범위의 Volicord 권한을 발급할 수 있습니다. | [쓰기 준비 메서드](api/method-prepare-write.md), [저장 효과](storage-effects.md), [보안](security.md) |
