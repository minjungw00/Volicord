...
<!-- BEGIN GENERATED: contract-structures api.method.status.response[response_variants] api.method.status.response[result_body] api.method.status.response[rejection] -->
<!-- Generated by `cargo run -p xtask -- docs-sync`; do not edit this region. -->
...
<!-- END GENERATED: contract-structures api.method.status.response[response_variants] api.method.status.response[result_body] api.method.status.response[rejection] -->
