...
| 사용자 판단 Method 동작 | [사용자 판단 메서드](method-user-judgment.md) |
| `harness.close_task` Method 동작 | [Task 닫기 메서드](method-close-task.md) |

Method별 질문은 다음 담당 문서로 라우팅합니다.

- Method 동작: 위 표의 해당 Method 담당 문서
- Method별 payload field: 위 표의 해당 Method 담당 문서
- 요청과 응답 branch 형태: [`schema-core.md`](schema-core.md)
- 중첩 state field: [`schema-state.md`](schema-state.md)
- 아티팩트 field: [`schema-artifacts.md`](schema-artifacts.md)
- 사용자 판단 field: [`schema-judgment.md`](schema-judgment.md)
- 값 집합: [`schema-value-sets.md`](schema-value-sets.md)
- 저장 효과: [`../storage-effects.md`](../storage-effects.md)
- Public 오류: [`errors.md`](errors.md)
- API 예시 정합성: [작성 가이드](../../maintain/authoring-guide.md), [점검](../../maintain/checks.md)

<a id="shared-request-rules"></a>
<a id="공통-요청-규칙"></a>

## 공통 요청 래퍼와 응답 branch 경로

공통 API 형태는 [API 코어 스키마](schema-core.md)가 담당합니다.

- 요청 래퍼: [`ToolEnvelope`](schema-core.md#tool-envelope)
- 응답 branch: [공통 응답 branch](schema-core.md#common-response)
- 공통 결과 기반: [`ToolResultBase`](schema-core.md#common-response)
- 거부와 `dry_run` branch: [공통 응답 branch](schema-core.md#common-response)의 `ToolRejectedResponse`와 `ToolDryRunResponse`
- Method result branch 허용 여부: 해당 Method 담당 문서
...
- Method별 `task_id` field: 해당 Method 담당 문서

## 스키마 담당 문서 링크

- 요청과 응답 branch 형태: [API 코어 스키마](schema-core.md)
- 중첩 state field: [API 상태 스키마](schema-state.md)
- 아티팩트 field: [API 아티팩트 스키마](schema-artifacts.md)
- 사용자 판단 field: [API 판단 스키마](schema-judgment.md)
- 값 집합: [API 값 집합](schema-value-sets.md)
- Public 오류: [API 오류](errors.md)
...
예시는 전체 스키마 정의가 아니라 간결한 branch 예시입니다.

API 예시 질문은 다음 담당 문서로 라우팅합니다.

- 정합성 규칙과 교체 기준: [작성 가이드](../../maintain/authoring-guide.md), [점검](../../maintain/checks.md)
- 중첩 형태: 위의 스키마 담당 문서 링크
- Method payload field: 해당 Method 담당 문서
- 스키마 field: 해당 스키마 담당 문서
- 저장소 소유 예시 field: 해당 저장소 담당 문서
