...
- API 예시 정합성 규칙 또는 field name 일관성 규칙
...
method 동작을 확인할 때는 아래 담당 문서를 먼저 엽니다. method payload field 질문은 영향을 받는 method 담당 문서에서 시작합니다. 공통 응답 분기 스키마, 공통 요청 래퍼 field, 중첩 스키마 field, 저장 효과, 공개 오류 코드는 아래 담당 문서 링크를 따릅니다.
...
| method payload field | 위의 영향을 받는 method 담당 문서 |
| 공통 요청 래퍼 field와 중첩 스키마 field | [스키마 담당 문서 링크](#스키마-담당-문서-링크) |
...
API 예시 정합성 질문과 field name 일관성 질문은 [작성 가이드](../../maintain/authoring-guide.md)와 [점검](../../maintain/checks.md)으로 보냅니다. 구체적인 예시 field 정의는 그다음 영향을 받는 method, schema, 또는 저장소 담당 문서로 보냅니다.
