...
<!-- BEGIN GENERATED: contract-structures api.method.reconcile_changes.response[response_variants] api.method.reconcile_changes.response[result_body] api.method.reconcile_changes.response[rejection] api.method.reconcile_changes.response[dry_run] -->
<!-- Generated by `cargo run -p xtask -- docs-sync`; do not edit this region. -->
...
<!-- END GENERATED: contract-structures api.method.reconcile_changes.response[response_variants] api.method.reconcile_changes.response[result_body] api.method.reconcile_changes.response[rejection] api.method.reconcile_changes.response[dry_run] -->
