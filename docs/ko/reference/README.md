...
| Public API 또는 schema shape가 무엇인가? | [MCP API와 스키마](mcp-api-and-schemas.md)가 public tool/resource, request/response envelope, shared ref, error, idempotency, state conflict behavior, validator result schema를 담당합니다. |
