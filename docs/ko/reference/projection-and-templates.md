...
| MVP-1 사용자용 작은 출력 | MVP-1 사용자 작업 루프 | 활성 사용자용 세트는 정확히 [상태 카드](templates/status-card.md), [판단 요청](templates/judgment-request.md), [실행/근거 요약](templates/run-evidence-summary.md), [닫기 결과](templates/close-result.md)입니다. 이 출력은 현재 상태, 막힌 이유, 사용자가 결정할 것, 다음 안전한 행동, 근거 요약, 남은 위험, 닫기 가능 여부, 보장 수준, 출처/최신성 참조를 보여주되 전체 report body를 요구하지 않습니다. |
...
| 사용자용 | [실행/근거 요약](templates/run-evidence-summary.md) | 최소 실행과 근거 요약. |
| 사용자용 | [닫기 결과](templates/close-result.md) | 닫기 준비 상태, 최종 수락, 잔여 위험, 막힘. |
