...
현재 범위의 canonical 설명은 [현재 MVP 범위 참조](active-mvp-scope.md)를 확인하세요. 현재 단계와 인계 상태는 [MVP 계획](../build/mvp-plan.md#문서-수락-상태)이 담당합니다.

| 항목 | 현재 상태 | 담당 | 실행 가능 여부 |
|---|---|---|---|
| 현재 문서 기준 | 활성 참조 기준 | `docs/ko/reference/conformance.md` | 아니요. 런타임 실행 기준이 아닙니다. |
| 계획된 내부 smoke target | 계획/문서화됨 | [MVP 계획](../build/mvp-plan.md#첫-내부-스모크-목표) | 아니요. |
