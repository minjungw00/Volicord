...
| Generated projections | Managed Markdown, compact status card, report, generated connector view는 stale, edited, prompt-injected 될 수 있고 authority로 오해될 수 있습니다. | Projection은 읽기용 view 또는 proposal surface로 취급합니다. Freshness, managed-block hash, reconcile은 state에 영향을 주기 전에 owner path를 거칩니다. |
