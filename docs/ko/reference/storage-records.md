...
| `state.sqlite` | `tasks` | 작업 단위 상태 | 사용자 가치 작업 단위, 구체화 요약, 범위와 닫기 근거의 개정 정보, `null` 허용 현재 닫기 근거, 생명주기/결과/종료 닫기 요약, 현재 적용 `CompletionPolicy`, 현재 적용 Change Unit 포인터, 생성자 행위자 출처. |
