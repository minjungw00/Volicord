...
| `crates/volicord-store/src/integration_verification/tests/` | Begin, probe, correlation, status, 동시 최초 acknowledgement를 위한 lifecycle 담당 테스트와 assertion에서 분리한 공유 fixture 구성. |
