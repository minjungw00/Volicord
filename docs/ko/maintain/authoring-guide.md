...
| Undefined active API schema type | [MVP API](../reference/api/mvp-api.md), [API Schema Core](../reference/api/schema-core.md), [API Schema Later](../later/index.md#later-schema-candidates), [API Errors](../reference/api/errors.md) | Build 문서, Agent Integration, later operations summary, conformance example | Active API method나 response가 active schema owner가 정의하지 않았거나 later/profile owner로 명확히 보내지 않은 schema type, shared ref, error shape, `CloseTaskResponse`, `ArtifactRef`, `ValidatorResult`, envelope member를 이름 붙입니다. |
| Storage/DDL collisions | [Storage](../reference/storage.md) | Build implementation sequencing, Runtime Boundaries, later operations 진단, Conformance fixture note, README route | Table name, DDL profile, JSON `TEXT`, enum hardening, migration/lock/artifact/projection-job storage rule, persisted status value가 Storage와 다르거나 Storage 밖에 중복됩니다. |
...
| Security/local-access guarantee overclaim risk | [보안 참조](../reference/security.md)를 봅니다. 대상 operation의 exact API, storage, Core, connector, conformance owner도 함께 봅니다. 향후 운영 후보는 [Later 후보 색인: 운영 후보](../later/index.md#operations-candidates)에 남깁니다. | Start/Use status wording, Agent Integration, Build stage summary, later operations 진단, README route | Cooperative 또는 detective behavior가 해당 operation에 대해 owner가 문서화한 mechanism과 proof path 없이 preventive, isolated, OS permission, arbitrary-tool sandboxing, tamper-proof, pre-tool blocking처럼 설명됩니다. |
| Conformance proof scope ambiguity | [적합성 참조](../reference/conformance.md), [Later 후보 색인: Future fixture families](../later/index.md#future-fixture-families), future entrypoint 후보는 [Later 후보 색인: 운영 후보](../later/index.md#operations-candidates) | Build readiness summary, 문서 점검표, Reference README, Roadmap, later operations summary | Documentation check, MVP behavior example, future fixture, runtime conformance가 섞입니다. 예시를 runnable suite나 현재 pass/fail 기준이라고 부르거나 docs-maintenance result를 runtime conformance처럼 다룹니다. |
| Conformance assertion structure drift | [적합성 참조](../reference/conformance.md)와 [Later 후보 색인: Future fixture families](../later/index.md#future-fixture-families) | Build readiness summary, 문서 점검표, Reference README, Roadmap, later operations summary | Conformance example이 Core state, storage row, 안정화된 event, error, artifact ref, blocker, guarantee fact에 대한 structured assertion 대신 prose-only expectation이나 rendered Markdown에 의존합니다. |
| User output vs agent context mixing | [Agent 통합 참조](../reference/agent-integration.md)와 [Projection과 Template 참조](../reference/projection-and-templates.md) | User Guide, Agent Guide, template, README route, Start example, later operations summary | 사용자에게 보이는 summary, status card, projection, retrieved context, chat memory가 operational authority, Write Authorization, gate 충족, 사용자 판단, 증거, QA, 최종 수락, 잔여 위험 수락, close를 만족하는 것으로 쓰입니다. |
...
| Release Handoff와 export | [Later 후보 색인: 운영 후보](../later/index.md#operations-candidates); later rendered shape은 승격 전까지 [Later template 후보](../later/index.md#later-template-candidates)에 후보로만 남습니다. |
| docs-maintenance | Rule body는 [Authoring Guide: docs-maintenance checks](#docs-maintenance-checks), 최종 validation checklist는 [문서 점검표](documentation-checks.md)가 담당합니다. Future `docs/*/maintain/checks.md` route가 생기면 Maintain에 속하며 runtime conformance가 아닙니다. |
| Projection과 report surface | [Projection And Templates Reference](../reference/projection-and-templates.md) |
| Security asset, trust boundary, threat category, control category, guarantee-level meaning, high-risk cooperative/detective/preventive/isolated security expectation | Threat concept과 honest guarantee display는 [보안 참조](../reference/security.md)가 담당합니다. Exact API, storage, Core, connector, conformance behavior는 각 owner에 남고, 향후 운영 후보는 [Later 후보 색인: 운영 후보](../later/index.md#operations-candidates)에 남습니다. |
...
| Security asset, trust boundary, threat category, control category, guarantee-level meaning, high-risk cooperative/detective/preventive/isolated security expectation | Threat concept과 honest guarantee display는 `reference/security.md`; exact enforcement, API, storage, Core, connector, conformance behavior는 각 owner; 향후 운영 후보는 `later/index.md#operations-candidates` |
...
| 향후 운영 절차, future conformance run entrypoint 후보, doctor/recover/reconcile/export/artifact integrity 후보 | `later/index.md#operations-candidates`; runtime conformance 의미와 fixture assertion 경계는 `reference/conformance.md`; 문서 점검 보고는 Maintain 문서 |
