...
- Conformance runner와 executable fixture 표현은 [Conformance Fixtures 참조](../reference/conformance-fixtures.md)와 [Later 후보 색인: Future fixture families](../later/index.md#future-fixture-families)에서 future-oriented로 남습니다. 현재 runnable validation처럼 다루지 않습니다.
