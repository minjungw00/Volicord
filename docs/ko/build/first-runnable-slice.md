...
- Strict fixture body shape, assertion mode, primary error, artifact ref, projection assertion, seed validation은 여기서 복사하지 않고 [Conformance Fixtures 참조](../reference/conformance-fixtures.md#conformance-fixture-format)에 연결한다.
