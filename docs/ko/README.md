...
|---|---|---|
| 처음 읽는 사람 | [15분 만에 보는 Harness](learn/harness-in-15-minutes.md) | [개요](learn/overview.md), [하나의 작업으로 보는 Harness](learn/harness-in-one-task.md), 그다음 [핵심 개념](learn/concepts.md) |
| 사용자 | [사용자 가이드](use/user-guide.md) | [Decision Packet Cookbook](use/decision-packet-cookbook.md), 그다음 Agent-facing 흐름이 필요하면 [Agent 세션 흐름](use/agent-session-flow.md) |
...
- [15분 만에 보는 Harness](learn/harness-in-15-minutes.md)
...
구현 방향을 파악하고 계획을 리뷰하기 위한 경로입니다. 첫 경로는 좁게 유지합니다. v0.1 Kernel MVP를 먼저 두고, Kernel Smoke를 그 좁은 conformance profile로 사용하며, v0.2부터 v0.4까지는 Agency-Hardened MVP를 향한 staged pack으로 다룹니다. v1+ Expansion은 owner 문서가 승격하고 증명하기 전까지 staged delivery 밖에 둡니다.
