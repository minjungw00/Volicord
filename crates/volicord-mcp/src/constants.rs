...
mod tests {
    ...
    fn server_instructions_preserve_outcome_across_shaping_and_implementation() {
        ...
        for required in [
            ...
            "Record shaping before implementation-oriented scope work",
            ...
            "apply each decision through the current resolution refs",
            "tagged workflow requires it and never while a UserAction is pending",
