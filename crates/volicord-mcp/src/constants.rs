...
mod tests {
    ...
    fn server_instructions_preserve_outcome_across_shaping_and_implementation() {
        ...
        for required in [
            ...
            "volicord.advance_task while a UserAction is pending",
