...
mod tests {
    ...
    fn server_instructions_preserve_outcome_across_shaping_and_implementation() {
        ...
        for required in [
            ...
            "resolved-but-unapplied decision",
            "resolution does not apply a shaping decision",
