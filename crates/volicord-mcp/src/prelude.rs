...
pub(crate) use volicord_store::{
    ...
    integration_verification::{
        ...
        current_guard_integration_verification_status, get_guard_integration_verification,
...
pub(crate) use volicord_types::{
    ...
    BeginIntegrationVerificationResult, CheckCloseRequest, CloseTaskRequest, EffectKind, ErrorCode,
    GetOperationResultRequest, GuardEventId, GuardIntegrationVerificationId, IdempotencyKey,
    IntakeRequest, IntegrationProfile, IntegrationVerificationIdArguments,
    IntegrationVerificationNextAction, McpAuthoritativeRefreshFailure, McpCheckCloseArguments,
