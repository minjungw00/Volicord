...
pub const MANAGED_GUIDANCE_FACTS: &[&str] = &[
    ...
    "update_scope_variant_selected_from_current_catalog",
    "replace_current_is_explicit_change_unit_retarget_or_rebaseline",
    "incompatible_keep_current_form_never_retried_for_replacement",
    ...
    "persisted_baseline_corruption_is_stored_state_failure",
    "persisted_baseline_corruption_stops_mutation",
    "persisted_data_failure_surfaces_exactly",
...
pub const WORKFLOW_ACTION_CONTRACT_FACTS: &[&str] = &[
    ...
    "update_scope_form_fixes_selected_change_unit_operation",
    "update_scope_baseline_is_agent_authored_next_baseline",
    "update_scope_create_replace_require_agent_authored_scope_summary_and_affected_paths",
    "keep_current_retarget_retry_selects_current_replace_variant",
