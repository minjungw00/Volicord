...
use crate::schema::{
    ...
    SensitiveActionScope, SourceRef, StagedArtifactHandle, StagingCreatedResultBase,
    StateRecordRef, StateSummary, SummaryCard, TaskFlowItem, TaskLifecycleState, TaskLineageInput,
    TaskLineageSummary, ToolDryRunBase, ToolDryRunResponse, ToolEnvelope, ToolError,
    ToolRejectedBase, ToolRejectedResponse, UnrecordedChange, UnrecordedChangeFinding,
    ...
    UserActionResolutionInput, UserActionResolutionRef, ValidatorResult, WorkspaceContext,
    WriteDecisionReason, WriteTicket, WriteTicketAttemptScope, WriteTicketPathPatterns,
    WriteTicketScope, WriteTicketStateSummary, WriteTicketValidityBasis,
};
